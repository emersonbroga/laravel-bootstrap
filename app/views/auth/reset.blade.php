  ...
  <body>
    ...
    <div class="container">
      {{ Form::open(array( 'url' => '/password/reset/process', 'class' => 'form-center', 'role' => 'form' )) }}
        ...
        <h2 class="form-center-heading">Password Reset</h2>
        {{ Form::hidden('token', $token) }}
        {{ Form::email('email', Input::old('email'), array('class' => 'form-control first', 'placeholder' => 'Email address') )}}
        {{ $errors->first('email', '<p class="text-danger">:message</p>') }}
        {{ Form::password('password', array('class' => 'form-control middle', 'placeholder' => 'Password') )}}
        {{ $errors->first('password', '<p class="text-danger">:message</p>') }}
        {{ Form::password('password_confirmation', array('class' => 'form-control last', 'placeholder' => 'Password confirmation') )}}
